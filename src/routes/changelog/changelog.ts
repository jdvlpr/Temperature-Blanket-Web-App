            ...
            notes: [
              {
                ...
                text: `30 colorways`,
                title: 'Added New Yarn: Loops & Threads - Demi Purl',
              },
            ],
            version: '5.43.0',
          },
            ...
            notes: [
              {
                ...
                instructions:
                  'If you previously tried to save the Sage Green colorway in your project or yarn palette, it instead saved it as the Kiwi colorway in most cases. So you may need to update your saved project or yarn palette by selecting the new Sage Green colorway instead of the Kiwi colorway.',
              },
            ],
            version: '5.27.0',
          },
            ...
            notes: [
              {
                icon: ICONS.design,
                instructions:
                  'Try it out in the Preview tab of the Project Planner',
    ...
    months: [
      ...
      `,
        ...
        <path stroke-linecap="round" stroke-linejoin="round" d="M16.862 4.487l1.687-1.688a1.875 1.875 0 112.652 2.652L10.582 16.07a4.5 4.5 0 01-1.897 1.13L6 18l.8-2.685a4.5 4.5 0 011.13-1.897l8.932-8.931zm0 0L19.5 7.125M18 14v4.75A2.25 2.25 0 0115.75 21H5.25A2.25 2.25 0 013 18.75V8.25A2.25 2.25 0 015.25 6H10" />
                ...
                instructions:
                  'Select a value from the weather data table to edit it.',
                text: '',
