    ...
    notes: [
      {
        ...
        text: `Collaborate and contribute to this website in the <a href=${PUBLIC_GITHUB_LINK} class="link" target="_blank">GitHub repository</a>`,
        title: 'Open Source!',
      },
    ],
    version: '4.0.0',
    ...
    notes: [
      {
        ...
        text: `37 colorways`,
        title: 'Added Yarn: Gepard - Pura Lana',
      },
    ],
    version: '3.37.0',
  },
