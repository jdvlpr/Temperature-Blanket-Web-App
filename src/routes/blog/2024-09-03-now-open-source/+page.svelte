      ...
      <div slot="content" class="pb-4 px-2">
        <div class="flex flex-col gap-4">
          ...
          <p>
            ...
            learned a lot! Now I believe the time is right to share the source
            code with the world.
          </p>
          ...
          <ul class="flex flex-col gap-2">
            ...
            <li>
              ...
              to better understand and recreate this project if they want. The source
              code helps explain how this site is made so that even without me, the
              tools and features can be recreated in some form.
            </li>
          </ul>
          ...
          <p>
            ...
            temperature-blanket.com. Changes to this site will still need to be
            approved by me, but anyone who wants is welcome to contribute. I
            look forward to hearing your ideas!
          </p>
          <p>
            Thank you to everyone who has used the site, provided feedback, and
            supported the project. I'm excited to see where we go from here!
          </p>
        </div>
      </div>
    </Card>
