...
<AppShell pageName="Privacy Policy">
  ...
  <main
    slot="main"
    class="max-w-screen-xl px-2 xl:px-0 flex flex-col gap-4 my-2"
  >
    ...
    <div class="flex flex-col">
      ...
      <p>Learn how this site uses cookies and manage your preferences below.</p>
      ...
      >
        ...
        <p>
          If you choose to accept Analytics, this site uses Microsoft Clarity to
          capture nonpersonally identifiable information about how you interact
          with temperature-blanket.com. Website usage data is captured using
          cookies to determine the popularity of services and features, and to
          inform future development and optimization. To see which cookies
          Microsoft Clarity sets, see the
          <a
    ...
    {#if PUBLIC_KOFI_LINK}
      <div class="flex flex-col">
        ...
        <p>
          You can make a donation to the developer of temperature-blanket.com at <a
            href={PUBLIC_KOFI_LINK}
            target="_blank"
            class="link">{kofiLinkTitle}</a
    ...
    <div class="flex flex-col">
      ...
      <p>
        Temperature-blanket.com uses Cloudflare to manage and protect traffic to
        this site. The data transfer between temperature-blanket.com and you is
        handled via Cloudflare's infrastructure to secure and stabilize the
        services of the site. To learn more, see the <a
