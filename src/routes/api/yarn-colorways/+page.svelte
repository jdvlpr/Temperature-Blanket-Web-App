  ...
  <main slot="main" class="max-w-screen-xl m-auto mb-4 pt-2 px-2 lg:px-0">
    ...
    "data": [
        ...
        >
          ...
          <p>When calling this endpoint, refer to the following parameters.</p>
            ...
            >
              ...
              >
                <tr>
                  <td>color</td>
                  <td
                    >An HTML hex color code, or any string that can be correctly
                    parsed as a color by
                    <a
                ...
                <tr>
                  <td>threshold</td>
                  <td
                    >The minimum percentage amount the yarn colorway must match
                    the supplied color, between
            ...
            >
              ...
              >
                ...
                <tr>
                  <td>percentMatch</td>
                  <td
                    >The percentage that the supplied color matches the colorway
                    hex, rounded down to the nearest integer.</td
                  >
                  <td>Number</td>
                </tr>
              </tbody>
...
`}
        ...
        <section id="status-codes" class="scroll-mt-[58px] gap-2 flex flex-col">
          ...
          <div class="overflow-scroll max-w-[80vw] sm:max-w-[90vw]">
            ...
            >
              ...
              >
                ...
                <tr>
                  <td>403</td>
                  <td>Forbidden: You're not allowed to access this endpoint</td>
                </tr>
                <tr>
                  <td>404</td>
                ...
                <tr>
                  <td>503</td>
                  <td
                    >Service Temporarily Unavailable: The API is currently down</td
                  >
                </tr>
              </tbody>
            </table>
