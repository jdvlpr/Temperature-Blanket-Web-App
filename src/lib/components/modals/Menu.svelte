...
{#if pages.save}
  <div class="">
    ...
    <p class="mt-2">
      This is your project's web address. To open your project again, paste this
      URL into your browser's address bar. Save the web address so you can
      access your project later.
    </p>
  </div>
{/if}
